                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-6">                                        
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <input name="Category_Name"  value="<?php echo $formData ? $formData['Category_Name']:"" ?>" type="text" class="form-control text-uppercase" placeholder="Enter Category Name">
                                                </div>
                                            </div>
                    							  </div>
                                		</div>
                                ...
                                <div class="text-right">
                                    <a href="<?php echo base_url('product-category'); ?>" class="btn btn-danger access-multiple-open legitRipple"><i class="icon-circle-left2 position-left"></i> Cancle </a>
