        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="display:flex">
              <a style="margin-right:5px;color:green" href="<?php echo base_url('brands/edit/'.$row['Brand_ID']); ?>"
                class="legitRipple"><i class="icon-pencil4 position-left"></i></a>
              <a style="margin-right:5px;color:red" href="<?php echo base_url('brands/remove/'.$row['Brand_ID']); ?>"
