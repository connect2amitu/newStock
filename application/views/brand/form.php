      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="col-lg-9">
              <input name="Brand_Name" value="<?php echo $formData ? $formData['Brand_Name'] : "" ?>" type="text"
                class="form-control text-uppercase" placeholder="Enter Brand Name">
            </div>
          </div>
        </div>
      </div>
      <div class="text-right">
        <a href="<?php echo base_url('brands'); ?>" class="btn btn-danger access-multiple-open legitRipple"><i
