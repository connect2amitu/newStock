  ...
  <div class="panel panel-flat">
    ...
    <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-9">
              <input name="Company_Name" value="<?php echo $formData ? $formData['Company_Name']:"" ?>" type="text"
                class="form-control text-uppercase" placeholder="Enter Company Name">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="text-right">
        <a href="<?php echo base_url('company'); ?>" class="btn btn-danger access-multiple-open legitRipple"><i
