          ...
          <td><?php echo $row['Sales_Invoice'] ?></td>
            ...
            <td><?php echo $row['Updated_By'] ?></td> -->
              ...
              <ul class="icons-list">
                ...
                <li class="text-success-600"><a href="#" data-popup="tooltip" title="View More" data-toggle="modal" data-target="<?php echo "#".$row['Sales_ID'] ?>" ><i class="icon-more"></i></a></li>
              </ul>
              </td>
              <div class="modal fade" id="<?php echo $row['Sales_ID'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
